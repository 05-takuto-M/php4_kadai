...
<body>
    ...
    <form action="todo_login_act.php" method="POST">
        <ul>
            <li><input type="text" name="username" placeholder="UserID" style="width:20vw;height:3vh;"></li>
            <li><input type="text" name="password" placeholder="Password" style="width:20vw;height:3vh;"></li>
        </ul>
        <button>Login</button>
        <a href="todo_register.php">New member registration</a>
    </form>
</body>
